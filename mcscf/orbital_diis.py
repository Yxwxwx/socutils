...
The extrapolated objects are anti-Hermitian logarithms of orbital rotations
relative to one fixed orthonormal reference.  Keeping every DIIS vector in the
same tangent frame avoids adding generators expressed in different MO bases.
"""
